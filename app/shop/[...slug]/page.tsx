...
export default async function ProductDetails({ params }: { params: { slug: string } }) {
  ...
  return (
    <Fragment>
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <div className="mb-4 mt-6">
                <span className="text-2xl font-bold mr-2 dark:text-white">${selectedProduct?.price}</span>
              ...
              <div className="flex items-center mb-4">
                {[...Array(Math.round(selectedProduct?.rating || 0))].map((_, i) => (
                  <svg
                    key={i}
      ...
      {Array.isArray(selectedProduct?.related) && selectedProduct.related.length > 0 && (
        <section className="related spad">
          <div className="container py-4">
            <div className="row">
              <div className="col-lg-12">
                <h3 className="related-title dark:text-white">Related Products</h3>
              </div>
            </div>
            <div className="row">
